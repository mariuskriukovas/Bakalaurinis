...
def execute_full_rx_noise_calculation():
    ...
    append_excel_sheets(df_arr=[df],
                        df_names=["Sheet_f_rx_gate_quito_Aprox"])
    ...
    append_excel_sheets(df_arr=[df],
                        df_names=["Sheet_f_rx_gate_yorktown_Aprox"])
...
def execute_full_ry_noise_calculation():
    ...
    append_excel_sheets(df_arr=[df],
                        df_names=["Sheet_f_ry_gate_quito_Aprox"])
    ...
    append_excel_sheets(df_arr=[df],
                        df_names=["Sheet_f_ry_gate_yorktown_Aprox"])
...
def execute_full_rz_noise_calculation():
    ...
    append_excel_sheets(df_arr=[df],
                        df_names=["Sheet_f_rz_gate_quito_Aprox"])
    ...
    append_excel_sheets(df_arr=[df],
                        df_names=["Sheet_f_rz_gate_yorktown_Aprox"])
...
def execute_full_p_noise_calculation():
    ...
    append_excel_sheets(df_arr=[df],
                        df_names=["Sheet_f_p_gate_quito_Aprox"])
    ...
    append_excel_sheets(df_arr=[df],
                        df_names=["Sheet_f_p_gate__yorktown_Aprox"])
